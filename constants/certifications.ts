...
export const certificates: Certificate[] = [
  ...
  {
    name: 'Chatbot using Natural Language Processing with Regex',
  ...
  {
    name: 'Transforming Industries Through Technology',
  ...
  {
    name: 'The Road to IT Consulting',
  ...
  {
    name: 'Mastering Cybersecurity Essentials',
  ...
  {
    name: 'Introduction to Secure Coding Practices',
